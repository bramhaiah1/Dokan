  ...
  <PaymentModel item={ item }   />
    ...
    <View style={styles.mainContainer}> 
     <Header style={styles.Header}>
        ...
        <Title style={styles.title}>Checkout</Title>
               ...
               <Badge
             value={props.navigation.getParam("count1")}
             status="primary"
             containerStyle={{ position: "absolute", right:width/8, bottom:height/50 }}
           />
            <Badge
             value={props.navigation.getParam("count")}
             status="primary"
    ...
    <Modal            
          ...
          onRequestClose = {() =>{ console.log("Modal has been closed.") } }>  
              ...
              <AntDesign  onPress = {() => {  
                  setvisible(!visible)}} name="closecircle" size={20} style={{alignSelf:"flex-end",color:colors.Hot,right:width/40,bottom:height/5.9,left:width/180}}/>
              ...
              <TouchableOpacity  onPress = {() => {  
                  props.navigation.navigate("Products1")}}  style={styles.submitBid}><Text style={{color:colors.white,textAlign:"center"}}>Back to shop</Text></TouchableOpacity>
...
<FlatList
         ...
         style={{ marginLeft:width/20,marginRight:width/12,marginTop:height/10,
